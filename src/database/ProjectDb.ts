...
export const projects: TProject[] = [
  {
    ...
    text: "Aplicação de gerenciamento de informações de influenciadores. Nele é possível cadastrar, editar e apagar dados, visualizar informações dos influenciadores cadastrados como nome, e-mail de contato, @ do canal, plataformas utilizadas e categorias de conteúdo.",
